...
enum shaderType { SPRITE_LOADING, GOOP, JAD, FIREBALL, SPRITE_UNTEXTURED, SPRITE_DEATH, ARENA, HEALTHPOT, MANAPOT, SPRITE_MAIN, BUTTON_START, 
					BUTTON_OPTIONS, BUTTON_QUIT, BUTTON_CONTROLS, BUTTON_RESTART, BUTTON_MAIN, BUTTON_QUIT2, SPRITE_PAUSE, SPRITE_CONTROLS, SPRITE_OPTIONS, SKYBOX};
