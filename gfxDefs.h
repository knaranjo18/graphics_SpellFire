...
enum shaderType { SPRITE_LOADING, GOOP, JAD, FIREBALL, SPRITE_UNTEXTURED, SPRITE_DEATH, ARENA, HEALTHPOT, MANAPOT, SKYBOX };
enum groundType { FOREGROUND, BACKGROUND };
enum GameState { START, LOADING, PLAYING, DEAD };
#endif
